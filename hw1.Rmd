...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: Hi, I am **Braedon**. I am currently a Junior studying *computer engineering* here at Iowa State. My interests include reading books and watching baseball. My interest in statistics / data science in fact originates from my love of baseball, as the statistical analysis (eg. Sabremetrics) done has always fascinated me.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: A job that relates to data science targeted advertising. The general concept is to collect massive amounts of data on potential viewers (for instance, web browser users, billboard viewers, etc.) and then to analyze the data and determine an ideal advertisement to present to the viewer. This can be done ahead of time, in the case of TV commercials and billboards, or it could be done in real time such as via advertisements. One example of targeted advertising is [Google AdSense](https://www.google.com/adsense/start/). Google AdSense uses data and machine learning models to make targeted adds specific to your website's current viewer. ![Targeted Ad](google_adsense.png)
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I am most interested in sports data. For instance, the [Sean Lahman Baseball Database](http://www.seanlahman.com/baseball-archive/statistics/)
